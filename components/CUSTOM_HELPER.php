...
class CUSTOM_HELPER
{
     ...
     * @return mixed
     */
    public static function GeneratePdf($user_id, $content, $file_name, $report_type, $from_date = null, $to_date = null)
    {
        $pdf = new Pdf([
            ...
            'methods' => [
                'SetHeader' => [Date('M d Y H:i:s') . " {$report_type} Report For {$from_date} TO {$to_date}"],
                'SetFooter' => ['{PAGENO}'],
            ]
        ]);
